...
class GiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gift" do
    assert_difference("Gift.count") do
      post gifts_url, params: { gift: { image_url: @gift.image_url, name: @gift.name, url: @gift.url } }
    end
  ...
  test "should update gift" do
    patch gift_url(@gift), params: { gift: { image_url: @gift.image_url, name: @gift.name, url: @gift.url } }
